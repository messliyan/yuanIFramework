...
/**
 * The exception thrown when a code retrieved from DB does not have a
 * corresponding definition in this application.
 *
 * Created on 15-9-3.
 *
 * @author gdong
...
public class CodeNotDefinedException extends RuntimeException {
   ...
   * to {@link #initCause}.
   */
  public CodeNotDefinedException() {
  }
   ...
   */
  public CodeNotDefinedException(String message) {
    super(message);
  }
   ...
   * @since 1.4
   */
  public CodeNotDefinedException(Throwable cause) {
    super(cause);
  }
