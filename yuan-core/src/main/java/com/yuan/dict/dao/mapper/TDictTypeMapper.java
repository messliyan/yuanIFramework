...
import static com.yuan.dict.dao.mapper.TDictTypeDynamicSqlSupport.*;
...
public interface TDictTypeMapper {
    ...
    BasicColumn[] selectList = BasicColumn.columnList(dictId, dictName, dictLabel, status, createBy, updateBy, createdAt, updatedAt, deletedAt, remark);
