...
import static com.yuan.dict.dao.mapper.TDictDataDynamicSqlSupport.TDictData;
import static com.yuan.dict.dao.mapper.TDictDataDynamicSqlSupport.createBy;
import static com.yuan.dict.dao.mapper.TDictDataDynamicSqlSupport.createdAt;
import static com.yuan.dict.dao.mapper.TDictDataDynamicSqlSupport.deletedAt;
import static com.yuan.dict.dao.mapper.TDictDataDynamicSqlSupport.dictCode;
import static com.yuan.dict.dao.mapper.TDictDataDynamicSqlSupport.dictRemarkDetail;
import static com.yuan.dict.dao.mapper.TDictDataDynamicSqlSupport.dictSort;
import static com.yuan.dict.dao.mapper.TDictDataDynamicSqlSupport.dictType;
import static com.yuan.dict.dao.mapper.TDictDataDynamicSqlSupport.dictValue;
import static com.yuan.dict.dao.mapper.TDictDataDynamicSqlSupport.id;
import static com.yuan.dict.dao.mapper.TDictDataDynamicSqlSupport.name;
import static com.yuan.dict.dao.mapper.TDictDataDynamicSqlSupport.status;
import static com.yuan.dict.dao.mapper.TDictDataDynamicSqlSupport.updateBy;
import static com.yuan.dict.dao.mapper.TDictDataDynamicSqlSupport.updatedAt;
...
public interface TDictDataMapper {
  ...
  BasicColumn[] selectList = BasicColumn
      .columnList(id, name, dictValue, dictSort, dictType, dictCode, status, createBy, updateBy,
          createdAt, updatedAt, deletedAt, dictRemarkDetail);
  ...
  @Generated("org.mybatis.generator.api.MyBatisGenerator")
  static UpdateDSL<UpdateModel> updateSelectiveColumns(DictData record,
  ...
  default long insertSelectiveReturningId(DictData record) {
    return MyBatis3Utils.insert(this::insert, record, TDictData, c ->
        c.map(name).toPropertyWhenPresent("name", record::getName)
            ...
            .map(dictRemarkDetail)
            .toPropertyWhenPresent("dictRemarkDetail", record::getDictRemarkDetail)
    );
  }
